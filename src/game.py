...
class Game:
    ...
    def __init__(self, gameMode=None) -> None:
        ...
        self.player1 = Player(Game.getInput("What is player 1's name? "), "X")
        self.player2 = Player(Game.getInput("What is player 2's name? "), "O") if self.isTwoPlayerGame() else Player('Computer', "O")
        self.board = Board()
